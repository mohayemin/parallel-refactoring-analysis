...
public class RefactoringTest {
    ...
    @CsvSource(
            ...
            value = {
                    ...
                    "Rename Parameter\trouteFile : String to routeFiles : List<String> in method public setRouteFiles(routeFiles List<String>) : void in class org.resthub.web.springmvc.router.RouterHandlerMapping----org.resthub.web.springmvc.router.RouterHandlerMapping.setRouteFiles(routeFiles List<String>).routeFile----",
                    ...
                    "Extract Method\tprivate executeForFileOpenedInEditor(event ExecutionEvent, appContext IEvaluationContext) : void extracted from public executeForSelection(event ExecutionEvent, selection ISelection, appContext IEvaluationContext) : Object in class de.bastiankrol.startexplorer.handlers.delegates.AbstractStartFromEditorHandlerDelegate----de.bastiankrol.startexplorer.handlers.delegates.AbstractStartFromEditorHandlerDelegate.executeForSelection(event ExecutionEvent, selection ISelection, appContext IEvaluationContext)----",
                    "Extract Method\tprivate executeForFile(event ExecutionEvent, file File) : Object extracted from public executeForSelection(event ExecutionEvent, selection ISelection, appContext IEvaluationContext) : Object in class de.bastiankrol.startexplorer.handlers.delegates.AbstractStartFromEditorHandlerDelegate----de.bastiankrol.startexplorer.handlers.delegates.AbstractStartFromEditorHandlerDelegate.executeForSelection(event ExecutionEvent, selection ISelection, appContext IEvaluationContext)----"
            }
    )
